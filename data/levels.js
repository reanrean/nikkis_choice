 ...
 */
 var levelBonus = {
  '清秀佳人': [addBonusInfo('S', 0.845, "中式现代")],
  '绝色无双': [addBonusInfo('S', 0.845, "中式现代")],
  '联盟委托: 1-1': [addBonusInfo('SS', 0.98, "睡衣"), addBonusInfo('SS', 0.98, "居家服")],
  '联盟委托: 1-2': [addBonusInfo('A', 1.188, "运动系")],
  '联盟委托: 1-3': [addBonusInfo('C', 2.0844, "泳装")],
  '联盟委托: 1-5': [addBonusInfo('A', 0.93337, "哥特风")],
  '联盟委托: 1-6': [addBonusInfo('B', 0.3, "欧式古典")],
  '联盟委托: 1-7': [addBonusInfo('B', 2.011, "洛丽塔")],
  '联盟委托: 2-1': [addBonusInfo('B', 1.8438, "中式古典")],
  '联盟委托: 2-4': [addBonusInfo('A', 0.244, "哥特风")],
  '联盟委托: 2-5': [addBonusInfo('C', 2.59633, "女仆装")],
  '联盟委托: 2-6': [addBonusInfo('A', 0.2218, "海军风")],
  '联盟委托: 2-7': [addBonusInfo('A', 1.235, "中式现代")],
  '联盟委托: 3-2': [addBonusInfo('SS', 1.3509, "沐浴")],
  '联盟委托: 3-3': [addBonusInfo('SS', 0.7831, "泳装")],
  '联盟委托: 3-4': [addBonusInfo('A', 1.4462, "和风")],
  '联盟委托: 3-6': [addBonusInfo('S', 0.3884, "中性风")],
  '联盟委托: 3-7': [addBonusInfo('S', 0.7452, "侠客联盟"), addBonusInfo('A', 0.3345, "欧式古典")],
  '联盟委托: 4-1': [addBonusInfo('A', 0.5146, "小动物")],
  '联盟委托: 4-2': [addBonusInfo('SS', 1.2085, "中式现代"), addBonusInfo('B', 1.2059, "中式古典")],
  '联盟委托: 4-3': [addBonusInfo('S', 0.4092, "运动系")],
  '联盟委托: 4-4': [addBonusInfo('C', 0.8734, "冬装")],
  '联盟委托: 4-5': [addBonusInfo('B', 2.2412, "婚纱")],
  '联盟委托: 4-6': [addBonusInfo('SS', 0.5058, "波西米亚")],
  '联盟委托: 5-1': [addBonusInfo('A', 0.9857, "民国服饰")],
  '联盟委托: 5-2': [addBonusInfo('B', 0.8944, "学院系"), addBonusInfo('B', 0.8944, "英伦")],
  '联盟委托: 5-3': [addBonusInfo('A', 1.314, "OL")],
  '联盟委托: 5-4': [addBonusInfo('SS', 0.9008, "摇滚风")],
  '联盟委托: 5-5': [addBonusInfo('S', 0.9735, "森女系列")],
  '联盟委托: 5-6': [addBonusInfo('C', 2.211, "防晒")],
  '联盟委托: 5-7': [addBonusInfo('C', 4.3321, "童话系")],
  "1-1": [],
  "1-2": [],
...
'3-支2' :[['较难S，公主级不穿婚纱连衣裙可S，但其它部位必须堆tag。'],['幽兰曲裾，玫瑰长裙，高腰娃娃裙等'],['']],
//4-3，4-4，4-7，改F表。
...
'4-7' :[['连衣裙疑似排斥中式古典及和风tag。上下装易F，推荐连衣裙。外套无限制。'],['鸣鹤之应•珍稀，淡络葡提，漫纱轻舞，烈火女神，怪盗上衣•华丽，荷花吟•裙'],['甜心骑士•裙，岚谧轻粉，金菊呈祥']],
...
'6-9' :[['外套容易F，没写可用的最好别穿。'],['愚者的欢乐，蝶舞天涯系列，繁华梦·珍稀，陆军少校，凌人风姿，雪绒披风，幻影披风，热夏·黑'],['花月裴']],
'6-10' :[['衣服容易F。较难S，建议做冬眠。小镇姑娘+灰色针织裙、美术老师·灰等，技能放好了公主可S。'],['冬眠，山枝桠，枫叶温度•红，小镇姑娘，美术老师•灰，灰色针织裙，高腰皮裤'],['']],
...
'7-2' :[['极易F，仅确定列出的可穿品！注：姹紫嫣红·珍稀、夕夜迢迢、淡络葡提，少女F。'],['雪绒披风，天蓝披风，巧克力披肩，月秋浦，古墓谪仙，水中月，巧克力物语，金迷纸醉，天蓝衬衫+菱格短裙系列'],['繁华梦•珍稀，巫女的短衣，月影轩，绿烟林微，一品朱衣，芙蓉曲']],
...
'7-9' :[['衣服容易F，外套无限制。'],['枫糖毛衣，高腰皮裤，冬眠，枫叶温度•红，圣诞风毛衣，针织毛衣•绿'],['暖秋•棕']],
'7-支1' :[['上下装容易F。'],['千尘，茶花纱缎•华丽，流霞缎，星星连衣裙，蕾丝云+条纹背带裙'],['祈祷之音，小满制服•蓝']],
'7-支2' :[[''],[''],['贺礼，梦幻礼服衣&裙']],
'7-支3' :[['较难S。可用上下装已反映在得分中。公主级推荐先做北地头发、和北地鞋或过膝军靴，不能S再做别的。'],['牛仔小妞'],['海军背心，棕色军装裤，白色军装裤']],
'7-支4' :[[''],['戏水裳'],['莫逆于心，水墨抄•上&下']],
'7-支5' :[[''],['游园•紫'],['']],
'8-1' :[[''],[''],['']],
'8-2' :[['公主级只能穿性感不良套装部件，头发不用珍稀，不可加任何其它衣服饰品包括妆容！（但新部件很多可用）少女级允许更多饰品和同tag其它服装，但连衣裙会F。'],[''],['花嫁头纱']],
'8-3' :[[''],['花嫁头纱'],['']],
...
'8-8' :[['要求服装与精灵相关，不然F。有奇葩可用品。'],['金迷纸醉，精灵鹿后，缤纷圣诞夜，蝶舞翩跹系列'],['雪之鸣唱+冰之吟诵']],
'8-9' :[[''],[''],['花嫁头纱，梦幻礼服衣&裙']],
...
'10-8' :[['要求学士服，但高音谱号、巧克力物语可用且分高。别穿外套！但很多新外套可用。'],['雪绒披风，音符跃动'],['雪绒披肩']],
'10-9-1' :[['衣服、外套要求魔力星套装（滑板战衣可用），有些新外套可用。少女级可用魔力+前沿少女；公主级，上下装最好有一件华丽，tag加分多，不能S的做外套/上下装华丽/升级技能/拉开分差。'],['云端厨娘围裙，蝶舞天涯系列，滑板战衣'],['滑板短裤，机械之心·上&下']],
...
'12-支1' :[['少女级，连衣裙极易F，似乎对颜色有要求；公主级无限制。外套无限制。'],['姹紫嫣红系列，红影乱，玄灵之凤舞，罗织红纱（低分）'],['以下均为少女级F、公主级可用：月影轩，韶颜倾城，古墓谪仙，一品朱衣，竹夜歌，夕夜迢迢，绿烟林微，喜绣缘，天启之龙腾，拂袖风，海上鹤，创世之凤舞，与子成说，与子偕老，明珠缘女&粉']],
'12-支2' :[[''],[''],['']],
'12-支3' :[[''],[''],['']],
...
'联盟委托: 3-2' :[[''],[''],['']],
'联盟委托: 3-3' :[[''],[''],['据说漆黑隧道F、静谧夜色·上+下F，待确认。']],
'联盟委托: 3-4' :[['连衣裙似乎要求和风tag，外套无限制'],[''],['']],
'联盟委托: 3-5' :[['连衣裙怀疑排斥所有中式以及和风的tag，但水芝之约系列可用。'],['月秋浦，蓝染外套，小家碧玉，金迷纸醉，荒原的花，仙雾森林•珍稀'],['']],
...
'联盟委托: 4-2' :[[''],['寄思纸，小家碧玉，杏花阁，初云衫/裤·蓝，诵霓裳·衣，白绸裤'],['蓝瓷·上衣，繁华梦']],
'联盟委托: 4-3' :[[''],['水手少女·白，樱桃汽水，沁蜜桃·裤裙'],['游园系列']],
'联盟委托: 4-4' :[[''],['枫叶大衣，漫雪，枫叶温度·蓝/红，祈祷之音·珍稀，小满制服·蓝，棒球上衣，高腰皮裤'],['森女羊系列']],
'联盟委托: 4-5' :[['连衣裙怀疑要求婚纱tag，如有误请反馈。'],['仙雾森林·珍稀，星夜卜，雪境羽'],['']],
'联盟委托: 4-6' :[[''],['荧珑·华丽'],['']],
'联盟委托: 4-7' :[['上下装容易F。'],['巧克力女仆'],['']],
...
'联盟委托: 5-5' :[[''],['草莓冰点·抹茶，暖茸，森女与麋鹿，丘丘，小然'],['求确认：森女羊·珍稀会不会F？']],
'联盟委托: 5-6' :[[''],['迷雾街头，沁蜜桃，薏米仁'],['']],
'联盟委托: 5-7' :[[''],['荧珑·华丽，桃心骑士，红马甲'],['']],
};
