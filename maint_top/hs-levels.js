//note: this is a model from ivansgift, please copy *levels*Raw & levelBonus from seal100x
...
var levelsRaw = {
  ...
  '12-5': [3, 2.3, 3, -2.3, 1.67],
  '12-6': [-1.2, -0.67, -2.1, 1.2, 0.67],
  '12-7': [1.5, 1.1, 2.3, 1.1, 1],
  '12-8': [-2.3, 2.3, 1.7, -1.7, 1],
  '12-9': [1.27, 0.67, -1.27, 0.67, 0.67],
  '12-支1': [-1.9, -1.27, -1.9, 1.27, -0.67],
  '12-支2': [1.33, 1.67, 1.33, 1.67, 1.67],
  '12-支3': [2.2, 1, 2.2, 1.67, 1]
};
 ...
 */
 var levelBonus = {
  "婚纱1-神秘少女": [],
  "婚纱2-见习婚纱设计师": [],
  "婚纱3-旅途坎坷": [addBonusInfo('A', 1, "晚礼服")],
  "婚纱4-甜美新娘": [addBonusInfo('A', 1, "洛丽塔")],
  "婚纱5-难言之隐？": [addBonusInfo('A', 1, "中式古典"), addBonusInfo('A', 1, "中式现代")],
  "1-1": [],
  "1-2": [],
  ...
  '12-3': [addBonusInfo('B', 0.5, "侠客联盟"), addBonusInfo('B', 0.5, "童话系")],
  '12-5': [addBonusInfo('C', 0.5, "原宿系")],
  '12-6': [addBonusInfo('A', 1, "中式古典")],
  '12-7': [addBonusInfo('S', 1, "运动系")],
  '12-8': [addBonusInfo('C', 1, "未来系")],
  '12-9': [addBonusInfo('S', 2, "波西米亚")],
  '12-支1': [addBonusInfo('C', 1, "中式古典")],
